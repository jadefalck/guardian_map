// src/pages/CoreeDuSud.jsx
import React from "react";
import CarteAvecEffetLibre from "../../components/CarteAvecEffetLibre";
import oceanImage from "../../assets/images/ocean.jpg";

export default function CoreeDuSud() {
  const species = [
    { name: "Poisson-lune (Mola mola)", region: "Île de Jeju" },
    { name: "Méduse crinière de lion", region: "Mer de l'Est" },
    { name: "Tortue verte", region: "Île de Jeju" },
    { name: "Seiche géante", region: "Uljin" },
    { name: "Poisson-perroquet", region: "Geoje" },
    { name: "Requin dormeur japonais", region: "Tongyeong" },
    { name: "Crabe géant du Pacifique", region: "Mer Jaune" },
    { name: "Poisson-globe", region: "Busan" },
    { name: "Calmar volant", region: "Mokpo" },
    { name: "Murène ruban", region: "Jeju" },
    { name: "Raie pastenague", region: "Pohang" },
    { name: "Poisson-lion", region: "Wando" },
  ];
      ...
      >
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl max-w-[1200px] mx-auto p-1 sm:p-1">
          <div className="rounded-xl overflow-hidden">
            <CarteAvecEffetLibre country="coree_du_sud" />
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-300 py-12 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-wrap gap-2 justify-center">
            {["Jan", "Fév", "Mar", "Avr", "Mai", "Juin", "Juil", "Aoû", "Sept", "Oct", "Nov", "Déc"].map((month, i) => {
              const colors = [
