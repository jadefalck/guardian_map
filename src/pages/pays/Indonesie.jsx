...
export default function Indonesie() {
  const species = [
    { name: "Raie manta géante", region: "Nusa Penida" },
    { name: "Poisson-lune (Mola Mola)", region: "Bali" },
    { name: "Requin de récif à pointe noire", region: "Raja Ampat" },
    { name: "Tortue imbriquée", region: "Gili Islands" },
    { name: "Poisson mandarin", region: "Lembeh" },
    { name: "Requin wobbegong", region: "Papouasie" },
    { name: "Seiche flamboyante", region: "Lembeh Strait" },
    { name: "Poisson fantôme orné", region: "Komodo" },
    { name: "Requin-marteau", region: "Banda Sea" },
    { name: "Crevette arlequin", region: "Bali" },
    { name: "Raie aigle", region: "Alor" },
    { name: "Thon à nageoires jaunes", region: "Flores" },
  ];
      ...
      >
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl max-w-[1200px] mx-auto p-4 grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="md:col-span-3 rounded-xl overflow-hidden">
            <CarteAvecDonnees country="indonesie" regionFilter={regionFilter} />
          </div>
