...
export default function Japon() {
  const species = [
    { name: "Requin marteau", region: "Yonaguni" },
    { name: "Tortue verte", region: "Kerama" },
    { name: "Raie manta", region: "Ishigaki" },
    { name: "Poisson-globe", region: "Okinawa" },
    { name: "Poisson-ange empereur", region: "Izu" },
    { name: "Cheval de mer pygmée", region: "Kume" },
    { name: "Pieuvre mimétique", region: "Amami" },
    { name: "Poisson lion", region: "Ogasawara" },
    { name: "Murène", region: "Shirahama" },
    { name: "Poisson-coffre", region: "Okinawa" },
    { name: "Requin baleine", region: "Okinawa" },
    { name: "Crabe orang-outan", region: "Kerama" },
  ];
