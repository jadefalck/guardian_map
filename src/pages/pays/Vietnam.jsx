// src/pages/Vietnam.jsx
import React, { useState } from "react";
import CarteAvecDonnees from "../../components/CarteAvecDonnees";
import oceanImage from "../../assets/images/ocean.jpg";
import data from "../../data/Vietnam_BDD_GF.json";

export default function Vietnam() {
  const species = [
    { name: "Poisson-clown", region: "Nha Trang" },
    { name: "Murène", region: "Con Dao" },
    { name: "Tortue imbriquée", region: "Phu Quoc" },
    { name: "Raie pastenague", region: "Cham Islands" },
    { name: "Seiche", region: "Phu Quoc" },
    { name: "Poisson-scorpion", region: "Hon Mun" },
    { name: "Poisson-papillon", region: "Con Dao" },
    { name: "Barracuda", region: "Nha Trang" },
    { name: "Poisson-ange", region: "Cham Islands" },
    { name: "Méduse", region: "Baie d'Halong" },
    { name: "Poisson-lion", region: "Phu Quoc" },
    { name: "Poisson-coffre", region: "Hon Mun" },
  ];
      ...
      >
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl max-w-[1200px] mx-auto p-4 grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="md:col-span-3 rounded-xl overflow-hidden">
            <CarteAvecDonnees country="vietnam" regionFilter={regionFilter} />
          </div>
          ...
          <div className="flex flex-wrap gap-2 justify-center">
            {["Jan", "Fév", "Mar", "Avr", "Mai", "Juin", "Juil", "Août", "Sept", "Oct", "Nov", "Déc"].map((month, i) => {
              const colors = [
                ...
                "bg-green-500", "bg-yellow-400", "bg-orange-400", "bg-orange-400",
