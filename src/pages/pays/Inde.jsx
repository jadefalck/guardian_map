...
export default function Inde() {
  const species = [
    { name: "Tortue olivâtre", region: "Andaman" },
    { name: "Raie manta", region: "Lakshadweep" },
    { name: "Poisson-clown", region: "Goa" },
    { name: "Poisson-ange royal", region: "Andaman" },
    { name: "Napoléon", region: "Havelock" },
    { name: "Poisson-scorpion", region: "Pondichéry" },
    { name: "Barracuda", region: "Lakshadweep" },
    { name: "Raie pastenague", region: "Andaman" },
    { name: "Requin à pointe noire", region: "Goa" },
    { name: "Seiche flamboyante", region: "Havelock" },
    { name: "Poisson-lion", region: "Andaman" },
    { name: "Murène", region: "Pondichéry" },
  ];
      ...
      >
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl max-w-[1200px] mx-auto p-1 sm:p-1">
          <div className="rounded-xl overflow-hidden">
            <CarteAvecEffetLibre country="inde" />
          </div>
        </div>
      </div>
          ...
          <div className="flex flex-wrap gap-2 justify-center">
            {["Jan", "Fév", "Mar", "Avr", "Mai", "Juin", "Juil", "Août", "Sept", "Oct", "Nov", "Déc"].map((month, i) => {
              const colors = [
                ...
                "bg-orange-400", "bg-orange-400", "bg-yellow-400", "bg-yellow-400",
