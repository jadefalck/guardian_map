...
/* ------------------ Utils: Poissons Malaisie depuis l’Excel ------------------ */
async function loadGroupedMalaisieSpecies() {
  ...
  // tolère "malaisie" / "malaysia"
  const targets = new Set(["malaisie", "malaysia"]);
  const my = rows.filter((r) => targets.has(String(r.pays || "").toLowerCase().trim()));
...
/* ------------------ Page Malaisie ------------------ */
export default function Malaisie() {
  // Carte + filtre région
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const rows = await loadGroupedMalaisieSpecies();
        if (!mounted) return;
        ...
        >
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl max-w-[1200px] mx-auto p-4 grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="md:col-span-3 rounded-xl overflow-hidden">
              <CarteAvecDonnees country="malaisie" regionFilter={regionFilter} />
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <Reveal zoomOnVisible className="ml-[6%]">
              <p className="mb-8 text-sm md:text-base text-gray-700 max-w-4xl text-justify">
                ...
                et à un tourisme durable — notamment à Sipadan, Tioman, Perhentian…
              </p>
            </Reveal>
              ...
              <Reveal delay={0} zoomOnVisible>
                <div className="group rounded-xl shadow-md border border-gray-200 overflow-hidden transition-transform duration-300 hover:scale-[1.02] hover:shadow-lg">
                  ...
                  <div className="p-4 text-sm text-gray-700 transition-transform duration-300 group-hover:scale-[1.01]">
                    ...
                    En choisissant des centres engagés,{" "}
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <Reveal zoomOnVisible className="ml-[6%]">
              <p className="mb-8 text-sm md:text-base text-gray-700 max-w-4xl text-justify">
                ...
                aux centres de plongée (Gold, Silver, Bronze, Inactive).
              </p>
            </Reveal>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 px-4">
              ...
              <Reveal delay={0} zoomOnVisible>
                ...
                >
                  ...
                  <div className="p-6 text-sm text-gray-700 group-hover:scale-[1.01] transition-transform">
                    Mise en œuvre exemplaire des meilleures pratiques environnementales.
                  </div>
                </div>
              </Reveal>
              ...
              <Reveal delay={120} zoomOnVisible>
                ...
                >
                  ...
                  <div className="p-6 text-sm text-gray-700 group-hover:scale-[1.01] transition-transform">
                    Fort engagement avec quelques axes d’amélioration.
                  </div>
                </div>
              </Reveal>
              ...
              <Reveal delay={240} zoomOnVisible>
                ...
                >
                  ...
                  <div className="p-6 text-sm text-gray-700 group-hover:scale-[1.01] transition-transform">
                    Bon respect des recommandations, quelques progrès possibles.
                  </div>
                </div>
              </Reveal>
              ...
              <Reveal delay={360} zoomOnVisible>
                ...
                >
                  ...
                  <div className="p-6 text-sm text-gray-700 group-hover:scale-[1.01] transition-transform">
                    N’a pas renouvelé, mais conserve souvent de bonnes pratiques.
                  </div>
                </div>
              </Reveal>
            </div>
        ...
        <div className="bg-gray-300 py-12 px-6">
          <div className="max-w-5xl mx-auto">
            ...
            <p className="ml-[4%] mb-4 text-sm md:text-base text-gray-700 max-w-3xl">
              Un aperçu des conditions de visibilité au fil des mois en Malaisie (côtes
              Est/Ouest pouvant varier).
            </p>
      ...
      <Reveal>
        <div className="bg-gray-100 py-12 px-6">
          ...
          <p className="ml-[10%] mb-6 text-sm md:text-base text-gray-700 max-w-4xl text-justify">
            Quelques espèces <span className="text-[#1113a2] font-semibold">emblématiques ou rares</span>{" "}
            que l’on peut rencontrer en Malaisie.
          </p>
...
/* ------------------ Visibilité: vague desktop (palette Malaisie) ------------------ */
function MonthsWaveMalaysia() {
  const isTouch = useIsTouch(); // pas de vague sur mobile/tablette
  const months = ["Jan","Fév","Mar","Avr","Mai","Juin","Juil","Août","Sept","Oct","Nov","Déc"];
  // Palette indicative Malaisie (Est meilleure ~avril-oct, Ouest plus variable)
  const colors = [
