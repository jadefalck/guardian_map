...
export default function Malaisie() {
  const species = [
    { name: "Tortue imbriquée", region: "Sipadan" },
    { name: "Requin à pointe noire", region: "Mabul" },
    { name: "Poisson-perroquet à bosse", region: "Redang" },
    { name: "Raie pastenague", region: "Perhentian" },
    { name: "Poisson-clown", region: "Tioman" },
    { name: "Napoléon", region: "Langkayan" },
    { name: "Poisson-ange empereur", region: "Redang" },
    { name: "Requin léopard", region: "Lankayan" },
    { name: "Seiche flamboyante", region: "Kapalai" },
    { name: "Poisson-scorpion", region: "Sipadan" },
    { name: "Raie aigle", region: "Mabul" },
    { name: "Barracuda", region: "Sipadan" },
  ];
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-wrap gap-2 justify-center">
            {[
              ...
              const colors = [
                "bg-green-500", "bg-green-500", "bg-green-500", "bg-yellow-400",
                "bg-yellow-400", "bg-orange-400", "bg-orange-400", "bg-yellow-400",
